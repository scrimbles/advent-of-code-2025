...
1. You could press the first three buttons once each, a total of 3 button presses.
2. You could press (1,3) once, (2,3) once, and (0,1) twice, a total of 4 button presses.
3. You could press all of the buttons except (1,3) once each, a total of 5 button presses.
